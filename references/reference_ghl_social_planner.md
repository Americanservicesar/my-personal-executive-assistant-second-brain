...
## Action Items
- 🔴 RECONNECT LINKEDIN NOW — expires May 12, today is May 3 (9 days left)
  - Go to: https://login.myservicerobot.com/v2/location/PQp7xlYjxZKsi0CWsSA7/marketing/social-planner/settings
  - Settings → Connected Accounts → LinkedIn → Reconnect
  - Log in with the LinkedIn account for "American Services AR" page
  - After reconnect: verify LinkedIn is back in the AmServ group
  - Update this file with new expiry date once done
